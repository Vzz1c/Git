					...
					<div class="clearfix choose">
						<div id="specification" class="summary-wrap clearfix">
							...
							<dl>
								<dt>
									<div class="fl title">
									<i>${spec.attributeName} ||spec.attributeNam</i>
								</div>
								</dt>
								<#list spec.attributeValue as item>

								<dd><a  href="javascript:;" class="{{isSelected('${spec.attributeName}','${item}')?'selected':''}}"  ng-click="selectSpecification('${spec.attributeName}','${item}')">${item}</a></dd>
								</#list>
							</dl>
							</#list>
						</div>
